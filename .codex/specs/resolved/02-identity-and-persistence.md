...
- Identity user links to an optional merchant.
- Merchant and Admin roles are seeded.
- Login, logout, registration, forgot-password, and reset-password flows exist.
